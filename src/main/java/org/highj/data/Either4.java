...
public abstract class Either4<A, B, C, D> implements __4<Either4.µ, A, B, C, D> {
    ...
    public <A_, B_, C_, D_> Either4<A_, B_, C_, D_> quadMap(
        ...
        return either(a -> Either4.E1(fn1.apply(a)),
                b -> Either4.E2(fn2.apply(b)),
                c -> Either4.E3(fn3.apply(c)),
                d -> Either4.E4(fn4.apply(d)));
    }
    ...
    public boolean equals(Object obj) {
        if (obj instanceof Either4 that) {
