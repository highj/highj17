...
public abstract class Either3<A, B, C> implements __3<Either3.µ, A, B, C> {
    ...
    public <A_, B_, C_> Either3<A_, B_, C_> trimap(
        ...
        return either(a -> Either3.Left(leftFn.apply(a)),
                b -> Either3.Middle(middleFn.apply(b)),
                c -> Either3.Right(rightFn.apply(c)));
    }
    ...
    public boolean equals(Object obj) {
        if (obj instanceof Either3 that) {
