...
public interface Traversable1<T> extends Traversable<T>, Foldable<T> {
    ...
    default <A,B,F> __<F,__<T,B>> traverse1(Apply<F> apply, Function<A,__<F,B>> fn, __<T,A> traversable) {
        return sequence1(apply, map(fn, traversable));
    }

    //sequence1 :: Apply f => t (f b) -> f (t b)
    //sequence1 = traverse1 id
    default <B, F> __<F,__<T,B>> sequence1(Apply<F> apply, __<T,__<F,B>> traversable) {
